...
public class ThreadOpenAiClient extends OpenAiClient {
    ...
    @Autowired
    public ThreadOpenAiClient(final SimpleOpenAI openAiClient) {
        super(openAiClient);
    }

    public CompletableFuture<Thread> createThread(final ThreadRequest threadRequest) {
        return handleRequestWithRetry(client -> client.threads()
    ...
    public CompletableFuture<ThreadMessage> createThreadMessage(final String threadId,
        ...
        return handleRequestWithRetry(client -> client.threadMessages()
    ...
    public CompletableFuture<ThreadRun> runThread(final String threadId, final ThreadRunRequest threadRunRequest) {
        return handleRequestWithRetry(client -> {
            final ThreadRun run = client.threadRuns()
